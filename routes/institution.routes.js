...
router.get('/profile',authenticate ,authorize("institution","admin"),institutionController.getProfile);    //get own intitution profile
...
router.get("/documents",authenticate,authorize("institution","admin"),institutionController.getDocuments)      //get institution documents
